...
<div class="wrap">
    ...
    <?php // $active_tab is set by render_settings_page() before including this template. ?>
    <nav class="nav-tab-wrapper">
        ...
        <a href="<?php echo esc_url(admin_url("options-general.php?page=wireservice&tab=records")); ?>"
           class="nav-tab <?php echo esc_attr($active_tab === "records" ? "nav-tab-active" : ""); ?>">
    ...
    <div class="wireservice-settings">
                ...
                <tr>
                    ...
                    <td>
                        <select name="wireservice_pub_name_source" id="wireservice_pub_name_source" class="regular-text">
                            <?php foreach ($name_sources as $wireservice_key => $wireservice_source): ?>
                                <option value="<?php echo esc_attr($wireservice_key); ?>" data-value="<?php echo esc_attr($wireservice_source["value"]); ?>" <?php selected($name_source, $wireservice_key); ?>>
                                    <?php echo esc_html($wireservice_source["label"]); ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                ...
                <tr>
                    ...
                    <td>
                        <select name="wireservice_pub_description_source" id="wireservice_pub_description_source" class="regular-text">
                            <?php foreach ($desc_sources as $wireservice_key => $wireservice_source): ?>
                                <option value="<?php echo esc_attr($wireservice_key); ?>" data-value="<?php echo esc_attr($wireservice_source["value"]); ?>" <?php selected($desc_source, $wireservice_key); ?>>
                                    <?php echo esc_html($wireservice_source["label"]); ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                        <p class="description" id="wireservice-pub-desc-current-value">
                            ...
                            $wireservice_desc_value = $desc_sources[$desc_source]["value"] ?? $desc_sources["wordpress_tagline"]["value"];
                            echo esc_html(mb_substr($wireservice_desc_value, 0, 100) . (mb_strlen($wireservice_desc_value) > 100 ? "..." : ""));
                            ?></em>
                        </p>
                ...
                <tr>
                    ...
                    <td>
                        <select name="wireservice_pub_icon_source" id="wireservice_pub_icon_source" class="regular-text">
                            <?php foreach ($icon_sources as $wireservice_key => $wireservice_source): ?>
                                <option value="<?php echo esc_attr($wireservice_key); ?>" <?php selected($icon_source, $wireservice_key); ?>>
                                    <?php echo esc_html($wireservice_source["label"]); ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                        ...
                        <div id="wireservice-pub-icon-preview" style="<?php echo esc_attr('margin-top: 8px;' . (empty($icon_preview_url) ? ' display:none;' : '')); ?>">
                        ...
                        <div id="wireservice-pub-custom-icon-field" style="display:none; margin-top: 8px;">
                            ...
                            <button type="button" class="button" id="wireservice-pub-icon-remove" style="<?php echo esc_attr(empty($custom_icon_id) ? 'display:none;' : ''); ?>"><?php esc_html_e("Remove", "wireservice"); ?></button>
                            <div id="wireservice-pub-custom-icon-preview" style="margin-top: 8px;">
                                <?php if ($custom_icon_id): ?>
                                    <?php $wireservice_custom_preview = wp_get_attachment_image_url($custom_icon_id, [64, 64]); ?>
                                    <?php if ($wireservice_custom_preview): ?>
                                        <img src="<?php echo esc_url($wireservice_custom_preview); ?>" alt="" style="width: 64px; height: 64px; object-fit: cover; border-radius: 4px;">
                                    <?php endif; ?>
                                <?php endif; ?>
                            </div>
                        </div>
                ...
                <tr>
                    ...
                    <td>
                        <select name="wireservice_doc_title_source" id="wireservice_doc_title_source">
                            <?php foreach ($doc_title_sources as $wireservice_key => $wireservice_label): ?>
                                <option value="<?php echo esc_attr($wireservice_key); ?>" <?php selected($doc_title_source, $wireservice_key); ?>>
                ...
                <tr>
                    ...
                    <td>
                        <select name="wireservice_doc_description_source" id="wireservice_doc_description_source">
                            <?php foreach ($doc_desc_sources as $wireservice_key => $wireservice_label): ?>
                                <option value="<?php echo esc_attr($wireservice_key); ?>" <?php selected($doc_desc_source, $wireservice_key); ?>>
                                    <?php echo esc_html($wireservice_label); ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                ...
                <tr>
                    ...
                    <td>
                        <select name="wireservice_doc_image_source" id="wireservice_doc_image_source">
                            <?php foreach ($doc_image_sources as $wireservice_key => $wireservice_label): ?>
                                <option value="<?php echo esc_attr($wireservice_key); ?>" <?php selected($doc_image_source, $wireservice_key); ?>>
                                    <?php echo esc_html($wireservice_label); ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
        ...
        <form method="post" action="<?php echo esc_url(admin_url("admin-post.php")); ?>" id="wireservice-reset-form">
